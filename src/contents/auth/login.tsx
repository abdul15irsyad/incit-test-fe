        ...
        <div className="p-6 space-y-4 md:space-y-6 sm:p-8">
          ...
          <div className="flex justify-between gap-4">
            <Link
              ...
              className="text-white w-full flex justify-center items-center gap-1 border border-white focus:ring-0 rounded-lg text-sm px-5 py-2.5 text-center dark:border-white"
            >
          ...
          <FormProvider {...methods}>
            <form className="space-y-4" onSubmit={onSubmit}>
              ...
              <button
                ...
                className="w-full text-white bg-blue-600 hover:bg-blue-700 dark:disabled:bg-gray-700 dark:disabled:text-gray-300 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"
              >
